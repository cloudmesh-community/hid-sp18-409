...
\subsubsection{Auto completed Addresses Search}
\subsubsection{Show crime data in makers mode}
\subsubsection{Show crime data in cluster mode}
\subsubsection{Plots for crime analysis}
