...
Attribute Information:describe data set and column names
...
\begin{itemize}
	...
	scikit-learn >= 0.18
	pyspark >= 2.1.1
	java 8.0 run time environment
	Apache Spark standalone version
