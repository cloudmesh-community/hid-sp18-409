...
\begin{description}
	...
	\item[Case Number]: The Chicago Police Department record Number.
	\item[Date]: Date when the incident occurred.
	\item[Date]: The partially redacted address where the incident occurred.
	...
	\item[Domestic]: Indicates whether the incident was domestic-related.
	...
	\item[FBI Code]: Indicates the crime classification as outlined in the FBI.
...
application are shown in Figure~\ref{fig:screencapture}.
